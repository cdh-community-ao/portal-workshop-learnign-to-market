...
const participantes = {
  convidados: [
    { nome: "Maria Chimuco", area: "Convidado" },
    { nome: "Gracieth Dias", area: "Convidado" },
    { nome: "Edson Chimuco", area: "Convidado" },
    { nome: "Florindo Paciência", area: "Convidado" },
    { nome: "Engrácia João", area: "Convidado"},
    { nome: "Bernabé Jamba", area: "Convidado"},
    { nome: "Boaaventura Capessa", area: "Convidado"},
    { nome: "Florindo Paciência", area: "Convidado"},
    { nome: "Amadeu Euclica", area: "Convidado"},
    { nome: "Arnásio Mavunda", area: "Convidado"},
    { nome: "Simão Chitumba", area: "Convidado"},
    { nome: "Augusto Saluuma", area: "Convidado"},
    { nome: "Adriana Salustro", area: "Convidado"},
    { nome: "Fátima Tchiyoka", area: "Convidado"},
    { nome: "Fernanda Edmar Jamba", area: "Convidado"},
    { nome: "Benedito Esteves", area: "Convidado"},
    { nome: "David Romeu", area: "Convidado"},
    { nome: "Ruth Domingos", area: "Convidado"},
    { nome: "Maria Jorge", area: "Convidado"},
    { nome: "Afonso Mandjolo", area: "Convidado"}
  ],
  reservas:[
    { nome: "Feliciana Natividade", area: "Reserva"},
    { nome: "Itiandra Crispim", area: "Reserva"},
    { nome: "Tuyo Gabriel", area: "Reserva"},
    { nome: "Isabel Figueiredo", area: "Reserva"},
    { nome: "Albano Safutoka", area: "Reserva"},
    { nome: "Evaristo Adriano", area: "Reserva"},
    { nome: "Jacinto Kopitule", area: "Reserva"},
    { nome: "Luciano Adérito Sapato", area: "Reserva"},
    { nome: "Elaine Juliana", area: "Reserva"},
    { nome: "Dinis Elizandro Celestino", area: "Reserva"},
